...
const mockRegisterCodexHooks = vi.fn().mockReturnValue(true);
...
vi.mock('../../src/integrations/index.js', () => ({
  ...
  registerCodexHooks: (...args: unknown[]) => mockRegisterCodexHooks(...args),
  ...
  getCodexHooksPath: () => '/mock-home/.codex/hooks.json',
